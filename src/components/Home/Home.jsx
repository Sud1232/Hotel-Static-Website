...
function Home() {
  return (
    <>
      ...
      <div className="xl:w-auto xl:text-center xsm:p-6 xsm:w-[1250px] xsm:text-3xl xsm:text-center xl:text-lg xl:p-12 text-[#14274A] stroke-[#14274A] xl:font-medium z-10">
