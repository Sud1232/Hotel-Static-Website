...
function ContactUs() {
  return (
    <>
      <div className="bg-[#14274A] xsm:w-[1271px] xl:w-full xl:h-[200px]">
        <div>
        ...
        <div className="xsm:p-16 xsm:flex xsm:justify-center xsm:items-center xl:p-0 xl:flex xl:justify-center xl:items-center">
          <h1 className="xsm:text-4xl xl:text-4xl text-white font-bold">CONTACT US</h1>
        </div>
      </div>
      <div className="xl:space-y-1 xl:w-full text-[#14274A] xl:p-24 xsm:p-24 xsm:w-[1271px] xsm:text-left xsm:space-y-5">
      ...
      <div className="xsm:w-[1271px] xsm:justify-center xsm:flex xsm:flex-col xl:flex xl:flex-row xl:w-full text-[#14274A] xl:justify-evenly">
        <div className="xsm:w-full xsm:px-24 xsm:text-5xl xl:w-1/2 xl:px-24 xl:text-6xl xl:text-left xsm:text-center">
          <p className="xsm:text-5xl xl:text-xl xsm:gap-y-[30px]">497 Evergreen Rd. Roseville,</p>
          <p className="xl:text-xl xsm:text-5xl">CA 95673</p>
          <div className="xsm:flex xl:flex xl:justify-start xl:items-center xsm:justify-center xl:gap-x-3 xsm:gap-x-2">
            <p className="font-bold xl:text-xl xl:text-left xsm:pt-4 xl:pt-3 xl:pb-5 xsm:pb-1 xsm:text-5xl">View map</p><HiArrowLongRight className="xsm:w-16 xsm:h-20 xl:w-14 xl:h-20"></HiArrowLongRight>
          </div>
          <p className="xl:text-xl xl:pt-3">Phone: +44 345 678 903 <br />
