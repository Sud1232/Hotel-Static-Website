...
function Footer() {
  return (
    <>
      <div className="bg-[#14274A] xl:w-16 xl:h-12 xl:flex xl:rotate-45 xl:m-auto xl:ml-[46.5rem] xl:translate-y-8 xl:z-0 xl:relative xsm:relative xsm:w-20 xsm:h-20 xsm:rotate-45 xsm:ml-[600px] xsm:translate-y-10"></div>
