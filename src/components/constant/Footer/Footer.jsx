...
function Footer() {
  return (
    <>
      ...
      <div className="bg-[#14274A] xl:z-1 xl:absolute xsm:absolute text-white xl:flex xl:justify-around xl:w-full xl:p-10 xsm:w-[1270px]">
        <div className="xl:w-auto xsm:w-[1271px] xsm:flex xsm:flex-col xsm:text-center xl:flex xl:flex-col font-[adobe-garamond-pro] xsm:text-5xl xsm:p-12 xl:text-base xl:text-left">
          <p className="xl:text-2xl font-bold">LUXURY</p>
          <p className="xl:px-4">HOTELS</p>
