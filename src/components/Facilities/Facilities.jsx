...
function Facilities() {
  return (
    <>
      <div className="xsm:w-[1271px] xsm:h-screen xsm:bg-cover xsm:bg-center xl:relative xl:w-full xl:h-[95vh] xl:bg-cover xl:bg-center" style={{ backgroundImage: `url(${background2})` }}>
